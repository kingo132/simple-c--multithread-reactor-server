...
void EpollDispatcher::wait_and_handle_events(const std::function<void(int fd, bool is_readable)>& handler) {
    int num_events = epoll_wait(epoll_fd_, events_, MAX_EVENTS, 1000);
